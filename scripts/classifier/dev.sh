...
CUDA_VISIBLE_DEVICES=1 python scripts/classifier/train.py -c classifier/smol.yaml
CUDA_VISIBLE_DEVICES=2 python scripts/classifier/train.py -c classifier/smol.yaml
